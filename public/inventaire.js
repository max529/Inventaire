...
App.Http.Controllers.Inventaire.Achat = {};
_.App.Http.Controllers.Inventaire.Achat = Inventaire.App?.Http?.Controllers?.Inventaire?.Achat ?? {};
...
App.Http.Controllers.Inventaire.Historique.HistoriqueInfo=class HistoriqueInfo {
    static get Fullname() { return "App.Http.Controllers.Inventaire.Historique.HistoriqueInfo"; }
    type;
    id_materiel_variation;
    par;
    date;
...
App.Models.MaterielVariationGroupe.$schema={...(Aventus.Data?.$schema ?? {}), "id":"number","id_materiel_variation":"number","id_variation":"number","variation":"Inventaire.App.Models.Variation"};
...
App.Http.Controllers.Equipe.Materiel.EquipeMaterielRequest.Namespace=`Inventaire.App.Http.Controllers.Equipe.Materiel`;
__as1(_.App.Http.Controllers.Equipe.Materiel, 'EquipeMaterielRequest', App.Http.Controllers.Equipe.Materiel.EquipeMaterielRequest);
...
App.Http.Controllers.Equipe.EquipeResource.$schema={...(Aventus.Data?.$schema ?? {}), "id":"number","nom":"string","stock":"boolean"};
...
const EquipeItem = class EquipeItem extends Aventus.WebComponent {
    ...
    <div class="name">
        <span _id="equipeitem_1"></span>
        <mi-icon icon="star"></mi-icon>
    </div>
    <div class="actions">
...
App.Models.Equipe.$schema={...(Aventus.Data?.$schema ?? {}), "id":"number","nom":"string","stock":"boolean"};
...
App.Http.Controllers.AdminModelController=class AdminModelController extends AventusPhp.ModelController {
}
App.Http.Controllers.AdminModelController.Namespace=`Inventaire.App.Http.Controllers`;
__as1(_.App.Http.Controllers, 'AdminModelController', App.Http.Controllers.AdminModelController);
...
App.Models.User.$schema={...(Aventus.Data?.$schema ?? {}), "id":"number","nom":"string","prenom":"string","nom_utilisateur":"string","id_role":"Inventaire.App.Enum.Role"};
...
App.Http.Controllers.Equipe.EquipeController=class EquipeController extends _.App.Http.Controllers.AdminModelController {
...
App.Http.Controllers.Materiel.MaterielVariationGroupeResource=class MaterielVariationGroupeResource extends Aventus.Data {
    static get Fullname() { return "App.Http.Controllers.Materiel.MaterielVariationGroupeResource"; }
    variation;
}
App.Http.Controllers.Materiel.MaterielVariationGroupeResource.Namespace=`Inventaire.App.Http.Controllers.Materiel`;
App.Http.Controllers.Materiel.MaterielVariationGroupeResource.$schema={...(Aventus.Data?.$schema ?? {}), "variation":"Inventaire.App.Http.Controllers.Materiel.VariationResource"};
Aventus.Converter.register(App.Http.Controllers.Materiel.MaterielVariationGroupeResource.Fullname, App.Http.Controllers.Materiel.MaterielVariationGroupeResource);
__as1(_.App.Http.Controllers.Materiel, 'MaterielVariationGroupeResource', App.Http.Controllers.Materiel.MaterielVariationGroupeResource);

App.Http.Controllers.Materiel.MaterielVariationResource=class MaterielVariationResource extends Aventus.Data {
    static get Fullname() { return "App.Http.Controllers.Materiel.MaterielVariationResource"; }
    groups;
    id;
    nom;
    image;
}
App.Http.Controllers.Materiel.MaterielVariationResource.Namespace=`Inventaire.App.Http.Controllers.Materiel`;
App.Http.Controllers.Materiel.MaterielVariationResource.$schema={...(Aventus.Data?.$schema ?? {}), "groups":"Inventaire.App.Http.Controllers.Materiel.MaterielVariationGroupeResource[]","id":"number","nom":"string","image":"Inventaire.App.Models.MaterielImage"};
Aventus.Converter.register(App.Http.Controllers.Materiel.MaterielVariationResource.Fullname, App.Http.Controllers.Materiel.MaterielVariationResource);
__as1(_.App.Http.Controllers.Materiel, 'MaterielVariationResource', App.Http.Controllers.Materiel.MaterielVariationResource);
...
App.Http.Controllers.Materiel.GetInventaire.Response.$schema={...(Aventus.Data?.$schema ?? {}), "id":"number","equipe":"Inventaire.App.Http.Controllers.Equipe.EquipeResource","materiel":"Inventaire.App.Http.Controllers.Materiel.MaterielVariationResource","quantite":"number","date":"Date","par":"string"};
...
App.Http.Controllers.Equipe.GetInventaire.Response.$schema={...(Aventus.Data?.$schema ?? {}), "id":"number","materiel":"Inventaire.App.Http.Controllers.Materiel.MaterielVariationResource","quantite":"number","date":"Date","par":"string"};
...
App.Models.MaterielVariation.$schema={...(Aventus.Data?.$schema ?? {}), "id":"number","id_materiel":"number","materiel":"Inventaire.App.Models.Materiel"};
...
App.Models.Perte=class Perte extends Aventus.Data {
    static get Fullname() { return "App.Models.Perte"; }
    id;
    id_equipe;
    id_materiel_variation;
    quantite;
...
App.Models.Mouvement=class Mouvement extends Aventus.Data {
    static get Fullname() { return "App.Models.Mouvement"; }
    id;
    id_equipe_sortie;
    id_equipe_entree;
    id_materiel_variation;
...
App.Models.Achat=class Achat extends Aventus.Data {
    static get Fullname() { return "App.Models.Achat"; }
    id;
    id_equipe;
    id_materiel_variation;
    quantite;
...
App.Models.Inventaire.$schema={...(Aventus.Data?.$schema ?? {}), "id":"number","id_equipe":"number","id_materiel_variation":"number","quantite":"number","date":"Date","par":"string","equipe":"Inventaire.App.Models.Equipe","materiel":"Inventaire.App.Models.MaterielVariation"};
...
App.Http.Controllers.Inventaire.Achat.InventaireAchatController=class InventaireAchatController extends Aventus.HttpRoute {
    constructor(router) {
        super(router);
        this.request = this.request.bind(this);
    }
    async request(body) {
        const request = new Aventus.HttpRequest(`${this.getPrefix()}/data/inventaire/achat`, Aventus.HttpMethod.POST);
        request.setBody(body);
        return await request.queryJSON(this.router);
    }
}
App.Http.Controllers.Inventaire.Achat.InventaireAchatController.Namespace=`Inventaire.App.Http.Controllers.Inventaire.Achat`;
__as1(_.App.Http.Controllers.Inventaire.Achat, 'InventaireAchatController', App.Http.Controllers.Inventaire.Achat.InventaireAchatController);

const ModalInventaireAchat = class ModalInventaireAchat extends Modal {
    get 'variation'() {
    ...
    __getStyle() {
        let arrStyle = super.__getStyle();
        arrStyle.push(ModalInventaireAchat.__style);
        return arrStyle;
    }
    __getHtml() {super.__getHtml();
    this.__getStatic().__template.setHTML({
  ...
  "bindings": [
    {
      "id": "modalinventaireachat_1",
      "injectionName": "value",
      "eventNames": [
        "onChange"
      ],
      "inject": (c) => c.comp.__4efee192411d842bca24f09a939e11e0method1(),
  ...
  "pressEvents": [
    ...
    getTitle() {
        return `Achat de ${this.variation.nom} ${this.getVariations()}`;
    }
    getVariations() {
        const names = [];
...
ModalInventaireAchat.Namespace=`Inventaire`;
ModalInventaireAchat.Tag=`av-modal-inventaire-achat`;
__as1(_, 'ModalInventaireAchat', ModalInventaireAchat);
if(!window.customElements.get('av-modal-inventaire-achat')){window.customElements.define('av-modal-inventaire-achat', ModalInventaireAchat);Aventus.WebComponentInstance.registerDefinition(ModalInventaireAchat);}
...
App.Http.Controllers.Inventaire.Historique.Response.$schema={...(Aventus.Data?.$schema ?? {}), "historiques":"Inventaire.App.Http.Controllers.Inventaire.Historique.HistoriqueInfo[]"};
  ...
  "events": [
    {
      ...
      "fct": (c, ...args) => c.comp.loadMoreData.apply(c.comp, ...args),
      "isCallback": true
    }
  ],
  "pressEvents": [
    {
      "id": "modalhistorique_4",
      "onPress": (e, pressInstance, c) => { c.comp.reject(e, pressInstance); }
    }
  ]
});const templ0 = new Aventus.Template(this);templ0.setTemplate(`
            <div class="line" _id="modalhistorique_3"></div>
        `);templ0.setActions({
  "content": {
    "modalhistorique_3°@HTML": {
      "fct": (c) => `\n                ${c.print(c.comp.__96088c3823f02341204bbb7914b84118method4(c.data.historique))}\n            `,
      "once": true
    }
  }
});this.__getStatic().__template.addLoop({
    ...
    __defaultValuesSignal(s) { super.__defaultValuesSignal(s); s["equipe"] = undefined;s["variation"] = undefined; }
...
App.Http.Controllers.Inventaire.Mouvement.InventaireMouvementController=class InventaireMouvementController extends Aventus.HttpRoute {
    constructor(router) {
        super(router);
        this.request = this.request.bind(this);
    }
    async request(body) {
        const request = new Aventus.HttpRequest(`${this.getPrefix()}/data/inventaire/mouvement`, Aventus.HttpMethod.POST);
        request.setBody(body);
        return await request.queryJSON(this.router);
    }
}
...
const ModalInventaireMouvement = class ModalInventaireMouvement extends Modal {
    get 'variation'() {
					...
					set 'equipeSortie'(val) {
						this.__signals["equipeSortie"].value = val;
					}get 'equipeEntree'() {
						return this.__signals["equipeEntree"].value;
					}
    ...
    __getStyle() {
        let arrStyle = super.__getStyle();
        arrStyle.push(ModalInventaireMouvement.__style);
        return arrStyle;
    }
    __getHtml() {super.__getHtml();
    this.__getStatic().__template.setHTML({
  ...
  "bindings": [
    {
      "id": "modalinventairemouvement_1",
      "injectionName": "value",
      "eventNames": [
        "onChange"
      ],
      "inject": (c) => c.comp.__86aa5df7aefa315fd11dd30e333e28b4method1(),
      "extract": (c, v) => c.comp.__86aa5df7aefa315fd11dd30e333e28b4method2(v),
      "once": true,
      "isCallback": true
    },
    {
      "id": "modalinventairemouvement_3",
      "injectionName": "value",
      "eventNames": [
        "onChange"
      ],
      "inject": (c) => c.comp.__86aa5df7aefa315fd11dd30e333e28b4method3(),
      "extract": (c, v) => c.comp.__86aa5df7aefa315fd11dd30e333e28b4method4(v),
      "once": true,
      "isCallback": true
    },
    {
      "id": "modalinventairemouvement_4",
      "injectionName": "value",
      "eventNames": [
        "onChange"
      ],
      "inject": (c) => c.comp.__86aa5df7aefa315fd11dd30e333e28b4method5(),
  ...
  "pressEvents": [
    ...
    async loadData() {
        const list = await Aventus.Process.execute(EquipeRAM.getInstance().getListWithError());
        if (list) {
    ...
    __86aa5df7aefa315fd11dd30e333e28b4method2(v) {
        if (this) {
            this.equipeSortie = v;
        }
    }
    __86aa5df7aefa315fd11dd30e333e28b4method3() {
        return this.equipeEntree;
    }
    __86aa5df7aefa315fd11dd30e333e28b4method4(v) {
        if (this) {
            this.equipeEntree = v;
        }
    }
    __86aa5df7aefa315fd11dd30e333e28b4method5() {
        return this.nb;
    }
    __86aa5df7aefa315fd11dd30e333e28b4method6(v) {
        if (this) {
            this.nb = v;
        }
    }
...
const InventaireListItem = class InventaireListItem extends Aventus.WebComponent {
    ...
    static __style = `:host{border-top:1px solid var(--color-base-300);padding:8px 16px;position:relative}:host .line .main{align-items:center;display:flex;gap:20px}:host .line .main .nom,:host .line .main .variation,:host .line .main .quantite{flex-grow:1;transform:translateY(7px);width:33%}:host .line .main .key{display:none;width:100px}:host .line .main .modification{display:flex;justify-content:flex-end;width:60px}:host .line .main .modification .actions{display:flex}:host .line .main .modification av-icon-action{width:fit-content}:host .line .last-update{font-size:var(--font-size-sm);text-align:right;transform:translateY(5px);white-space:nowrap}:host .line:not(.exist) .main .nom{transform:translateY(0px)}:host .line:not(.exist) .main .variation{transform:translateY(0px)}:host .line:not(.exist) .main .quantite{transform:translateY(0px)}:host .line:not(.exist) .main .modification .actions .historique{display:none}:host .line:not(.exist) .last-update{display:none}:host(:first-child){border-top:none}@media screen and (max-width: 700px){:host{padding:16px 16px}:host .line .main{display:block;margin-bottom:5px;padding-right:53px;width:100%}:host .line .main .nom,:host .line .main .variation,:host .line .main .quantite{flex-grow:0;margin-top:5px;transform:translateY(0px);width:100%}:host .line .main .key{display:inline-block}:host .line .main .modification{position:absolute;right:10px;top:10px}:host .line .main .modification .actions{display:grid;grid-template-columns:1fr 1fr;gap:10px}:host .line .last-update{transform:translateY(0px);white-space:wrap}}`;
    __getStatic() {
  ...
  "pressEvents": [
    {
      ...
      "onPress": (e, pressInstance, c) => { c.comp.achat(e, pressInstance); }
    }
  ]
});this.__getStatic().__template.addIf({
...
const EquipeDetailsPage = class EquipeDetailsPage extends Page {
    get 'item'() {
					...
					set 'inventaires'(val) {
						...
						return this.__signals["voirVide"].value;
					}
					set 'voirVide'(val) {
  ...
  "injection": [
    ...
    async updateInventaire(inventaire) {
        ...
        if (equipe?.stock) {
            ...
            if (materiel) {
                const materielInv = await Aventus.Process.execute(new App.Http.Controllers.Materiel.GetInventaire.MaterielGetInventaireController().request({ id_materiel: materiel.id }));
                if (materielInv) {
...
const MaterielDetailsPage = class MaterielDetailsPage extends Page {
    ...
    set 'is_saving'(val) { this.setBoolAttr('is_saving', val) }    get 'inventaires'() {
					...
					set 'objName'(val) {
						...
						return this.__signals["voir_vide"].value;
					}
					set 'voir_vide'(val) {
...
`);templ1.setActions({
  ...
  "injection": [
    ...
    updateInventaire(inventaire) {
        ...
        if (this.item) {
            let totStock = this.inventaires.filter(p => p.equipe.stock).reduce((tot, inventaire) => tot + inventaire.quantite, 0);
            this.item.stock = totStock;
        }
        if (needSearch) {
            this.search();
        }
